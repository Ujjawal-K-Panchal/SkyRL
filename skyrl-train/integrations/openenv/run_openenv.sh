...
uv run --isolated --extra $INFERENCE_BACKEND --with "openenv@git+https://github.com/meta-pytorch/OpenEnv.git" --with "litellm>=1.75.5,!=1.82.7,!=1.82.8" -m integrations.openenv.entrypoints.main_openenv \
